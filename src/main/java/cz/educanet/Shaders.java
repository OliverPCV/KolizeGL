...
public class Shaders {
    private static final String vertexShaderSource = FileUtils.readFile("C:/PRG/Translation/vertex_shader.glsl");

    private static final String fragmentShaderSource = FileUtils.readFile("C:/PRG/Translation/fragment_shader.glsl");
